...
def recalculateSamplesToAudit(num_audited, a, gamma, m, o1, o2, u1, u2):
    "sample size calculation from ColoradoRLA v1.1: https://github.com/FreeAndFair/ColoradoRLA/issues/695"
...
def ballot_polling_risk_level(winner_votes, loser_votes, winner_obs, loser_obs):
    ...
    except (ValueError, OverflowError): # Add test case, reevaluate for OverflowError e.g. Lt Governer
